...
const Quiz = () => {
    ...
    const quizDurationInSeconds = 30 * 60; // 30 minutes in seconds
    const [timeRemaining, setTimeRemaining] = useState(quizDurationInSeconds);
                    ...
                    <div className="col-lg-8">
                        <div className="card p-4" style={{ background: '#3d3d3d', borderColor: '#646464' }}>
                            <div className="d-flex justify-content-between gap-md-3">
                                ...
                                <h5 style={{  color: '#ffffff', width: '200px', textAlign: 'right',  }}>
